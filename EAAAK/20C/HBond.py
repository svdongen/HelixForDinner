...
temperature = 20
inputfilename =  str(temperature) + "CHB.txt"
outputfilename = "HBondercentage.csv"
finaldatafilename = "HBondAverage.csv"

#set desired atom numbers of hydrogen bonds
atomlabel = ["freeSelString index 197 81 199\n"]
